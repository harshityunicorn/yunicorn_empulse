...
class AnnouncementFilterSheet extends StatefulWidget {
  ...
  const AnnouncementFilterSheet({Key? key, this.initialFilters})
    : super(key: key);

  @override
  State<AnnouncementFilterSheet> createState() => _UserFilterBottomSheetState();
  ...
  static Future<UserFilters?> show(
    ...
    return showModalBottomSheet<UserFilters>(
      ...
      builder: (context) =>
          AnnouncementFilterSheet(initialFilters: initialFilters),
    );
  }
}

class _UserFilterBottomSheetState extends State<AnnouncementFilterSheet> {
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.pop(
                  context,
                  UserFilters(selectedDepartment: selectedDepartment),
                );
              },
